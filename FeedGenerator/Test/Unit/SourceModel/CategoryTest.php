...
namespace MageTwoDev\FeedGenerator\Test\Unit\SourceModel;
...
use MageTwoDev\FeedGenerator\SourceModel\Category as SourceModelCategory;
...
final class CategoryTest extends TestCase
{
    ...
    private SourceModelCategory $sut;
    ...
    protected function setUp(): void
    {
        ...
        $this->sut = new SourceModelCategory($this->categoryList, $this->searchCriteriaBuilder);
    }
